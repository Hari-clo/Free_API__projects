...
def load_translators():
    tamil_translator = pipeline("translation", model="Helsinki-NLP/opus-mt-en-ta")
    hindi_translator = pipeline("translation", model="Helsinki-NLP/opus-mt-en-hi")
    french_translator = pipeline("translation", model="Helsinki-NLP/opus-mt-en-fr")
    return {
